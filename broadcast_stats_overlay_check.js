...
async function run() {
  ...
  // --- 6. PRESENTED BY: one black bar at the top, white artwork, with
  //     the web address left and the phone number right.
  {
    ...
    await paint(p2, rows);
    const ph = p2.window.getComputedStyle(p2.document.querySelector('.sponsor img')).height;
